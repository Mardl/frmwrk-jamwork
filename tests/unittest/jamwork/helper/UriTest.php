...
class UriTest extends \PHPUnit_Framework_TestCase
{
	...
	{
		$this->request = $this->getMockBuilder('jamwork\common\HttpRequest')->disableOriginalConstructor()->getMock();
		...
		$this->request->expects($this->exactly(1))->method('getAllParameters')->will($this->returnValue($params));
