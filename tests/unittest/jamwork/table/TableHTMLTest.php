...
class TableHTMLTest extends \PHPUnit_Framework_TestCase
{
	...
	{
		$row = $this->getMockBuilder('jamwork\table\TableRow')->disableOriginalConstructor()->getMock();
		...
		$this->head->expects($this->exactly(2))->method('getRows')->will($this->returnValue(array($row, $row)));

		$this->body->expects($this->exactly(2))->method('getRows')->will($this->returnValue(array($row, $row)));

		$this->foot->expects($this->exactly(2))->method('getRows')->will($this->returnValue(array($row, $row)));

		$row->expects($this->exactly(12))->method('getCells')->will($this->returnValue($cells));

		$this->head->expects($this->exactly(1))->method('getClasses')->will($this->returnValue('head'));

		$this->body->expects($this->exactly(1))->method('getClasses')->will($this->returnValue('body'));

		$this->foot->expects($this->exactly(1))->method('getClasses')->will($this->returnValue('foot'));

		$row->expects($this->exactly(6))->method('getClasses')->will($this->returnValue('row'));
	...
	{
		$row1 = $this->getMockBuilder('jamwork\table\TableRow')->disableOriginalConstructor()->getMock();

		$row2 = $this->getMockBuilder('jamwork\table\TableRow')->disableOriginalConstructor()->getMock();

		$this->head->expects($this->exactly(1))->method('getRows')->will($this->returnValue(array($row1, $row2)));

		$row1->expects($this->exactly(3))->method('getCells')->will($this->returnValue(array(1, 2)));

		$row2->expects($this->exactly(1))->method('getCells')->will($this->returnValue(array(1, 2, 3)));

		$this->foot->expects($this->exactly(1))->method('getRows')->will($this->returnValue(array($row1, $row1)));


		$method = new \ReflectionMethod($this->table, 'maxCellsInRow');
	...
	public function testInsertId()
	{
		...
		$method = new \ReflectionMethod($this->table, 'insertId');
		$method->setAccessible(true);
	...
	public function testInsertAttr()
	{
		...
		$method = new \ReflectionMethod($this->table, 'insertAttr');
		$method->setAccessible(true);
	...
	{
		$method = new \ReflectionMethod($this->table, 'getClasses');
		$method->setAccessible(true);
	...
	{
		$method = new \ReflectionMethod($this->table, 'nl');
		$method->setAccessible(true);
	...
	{
		$method = new \ReflectionMethod($this->table, 'tab');
		$method->setAccessible(true);
	...
	{
		$this->head = $this->getMockBuilder('jamwork\table\TableBody')->disableOriginalConstructor()->getMock();

		$this->foot = $this->getMockBuilder('jamwork\table\TableBody')->disableOriginalConstructor()->getMock();

		$this->body = $this->getMockBuilder('jamwork\table\TableBody')->disableOriginalConstructor()->getMock();
