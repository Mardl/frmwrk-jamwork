...
class TableTest extends \PHPUnit_Framework_TestCase
{
	...
	{
		$this->output->expects($this->exactly(1))->method('setId');
	...
	{
		$this->output->expects($this->exactly(1))->method('addClass');
	...
	{
		$this->output->expects($this->exactly(1))->method('setHead');
	...
	{
		$thead = $this->getMockBuilder('jamwork\table\TableBody')->disableOriginalConstructor()->getMock();
		...
		$this->output->expects($this->exactly(0))->method('setHead');
	...
	{
		$this->output->expects($this->exactly(1))->method('setFoot');
	...
	{
		$tfoot = $this->getMockBuilder('jamwork\table\TableBody')->disableOriginalConstructor()->getMock();
		...
		$this->output->expects($this->exactly(0))->method('setFoot');
	...
	{
		$this->output->expects($this->exactly(1))->method('setBody');
	...
	{
		$tbody = $this->getMockBuilder('jamwork\table\TableBody')->disableOriginalConstructor()->getMock();
		...
		$this->output->expects($this->exactly(0))->method('setBody');
	...
	{
		$this->output->expects($this->exactly(1))->method('generate');
	...
	{
		$this->output->expects($this->exactly(1))->method('generate')->will($this->returnValue('test for __toString'));
	...
	{
		$this->output = $this->getMockBuilder('jamwork\table\TableHTML')->disableOriginalConstructor()->getMock();
