...
class FormFactoryTest extends \PHPUnit_Framework_TestCase
{
	...
	{
		$method = new \ReflectionMethod($this->formFactory2, 'nextMarkerPrefix');
	...
	{
		$method = new \ReflectionMethod($this->formFactory, 'nextCounter');
	...
	{
		$method = new \ReflectionMethod($this->formFactory2, 'nextMarker');
	...
	{
		$method = new \ReflectionMethod($this->formFactory2, 'replaceMarker');
