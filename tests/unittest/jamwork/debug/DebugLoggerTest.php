...
class DebugLoggerTest extends \PHPUnit_Framework_TestCase
{
	...
	{
		$fb = $this->getMockBuilder('\FirePHP')->disableOriginalConstructor()->getMock();
		...
		$fb->expects($this->exactly(1))->method('log')->will($this->returnValue(true));
	...
	public function testLog_notactive()
	{
		...
		$fb->expects($this->exactly(0))->method('log')->will($this->returnValue(true));
	...
	public function testTodo_isShowTodoTrue()
	{
		...
		$fb->expects($this->exactly(1))->method('info')->will($this->returnValue(true));
	...
	public function testInfo_notactive()
	{
		...
		$fb->expects($this->exactly(0))->method('info')->will($this->returnValue(true));
	...
	public function testWarn_active()
	{
		...
		$fb->expects($this->exactly(1))->method('warn')->will($this->returnValue(true));
	...
	public function testWarn_notactive()
	{
		...
		$fb->expects($this->exactly(0))->method('warn')->will($this->returnValue(true));
	...
	public function testError_active()
	{
		...
		$fb->expects($this->exactly(1))->method('error')->will($this->returnValue(true));
	...
	public function testError_notactive()
	{
		...
		$fb->expects($this->exactly(0))->method('error')->will($this->returnValue(true));
	...
	public function testDump_active()
	{
		...
		$fb->expects($this->exactly(1))->method('dump')->will($this->returnValue(true));
	...
	public function testDump_notactive()
	{
		...
		$fb->expects($this->exactly(0))->method('dump')->will($this->returnValue(true));
	...
	public function testTrace_active()
	{
		...
		$fb->expects($this->exactly(1))->method('trace')->will($this->returnValue(true));
	...
	public function testTrace_notactive()
	{
		...
		$fb->expects($this->exactly(0))->method('trace')->will($this->returnValue(true));
	...
	public function testTable_active()
	{
		...
		$fb->expects($this->exactly(1))->method('table')->will($this->returnValue(true));
	...
	public function testTable_notactive()
	{
		...
		$fb->expects($this->exactly(0))->method('table')->will($this->returnValue(true));
	...
	public function testIsShowInfo()
	{
		...
		$method = new \ReflectionMethod($logger, 'IsShowInfo');
