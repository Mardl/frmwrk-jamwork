...
class HtmlTemplateTest extends \PHPUnit_Framework_TestCase
{
	...
	private $js = null;
	private $css = null;
	private $templateDir = 'tests/unittest/testTemplate/';
	...
	public function testReadFiles()
	{
		...
		$this->assertSame($cssScripts, array('tests/unittest/testTemplate/css/cssFile_1.css' => 'tests/unittest/testTemplate/css/cssFile_1.css'));

		$jsScripts = $this->readAttribute($this->template->js(), 'scripts');
		$this->assertSame($jsScripts, array('tests/unittest/testTemplate/js/jsFile_1.js' => 'tests/unittest/testTemplate/js/jsFile_1.js'));
	}
	...
	public function testSetTemplateDir()
	{
		...
		// Ohne Slash
		$method->invoke($this->template, 'tests/unittest/testTemplate');
		$templateDir = $this->readAttribute($this->template, 'templateDir');
		$this->assertSame($templateDir, $this->templateDir);
