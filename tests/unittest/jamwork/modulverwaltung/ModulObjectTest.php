...
class ModulObjectTest extends \PHPUnit_Framework_TestCase
{
	...
	private $testmodulnoversion = '';
	private $testmodulnoversion_path = '';

	private $testmodulnoname = '';
	private $testmodulnoname_path = '';
	...
	{
		$this->modul1 = 'unittest\module\testmodul1';
		$this->modul1_path = __DIR__ . '/../../module/testmodul1/';

		$this->testmodulnoversion = 'unittest\module\testmodulnoversion';
		$this->testmodulnoversion_path = __DIR__ . '/../../module/testmodulnoversion/';

		$this->testmodulnoname = 'unittest\module\testmodulnoname';
		$this->testmodulnoname_path = __DIR__ . '/../../module/testmodulnoname/';
