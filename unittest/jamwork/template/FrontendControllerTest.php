...
class FrontendControllerTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testProzess()
	{
		...
		$template = $this->getMockBuilder('jamwork\template\HtmlTemplate')
		...
		$response->expects($this->any())
             ->method('getReturns')
             ->will($this->returnValue(array('\module\xyCommand' => 'returnOutput', '\module\asdfCommand' => 'returnOutput2')));
		...
		$template->expects($this->any())
             ...
             ->will($this->returnValue(array('navigation' => 'navigation', 'main' => 'main')));
