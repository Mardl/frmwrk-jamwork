...
class HttpRequestTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testGetRequestUri()
	{
		...
		$this->assertSame('/runUnit.php'.$ret, $_SERVER['REQUEST_URI']);
	}
		
	/*public function testGetCommand()
	{
		$this->request->addCommand('command');	
		$this->request->addCommand('command2');	
		$this->request->addCommand('command3');	

		$arRet = $this->request->getCommand();

		$this->assertSame(array('command','command2','command3'),$arRet);		
	}*/
	...
	{
		$this->assertTrue($this->request->getHeader('unit-test'));
	}
	...
	public function testSetCookie()
	{
		...
		$this->assertSame($_COOKIE['testcookie'], 'abctest');
	}
	...
	{	
		...
		$this->assertFalse(isset($_COOKIE['testcookiedel']));
	}
	
	public function testGetScriptName()
	{
		$this->assertSame($this->request->getScriptName(), '?/runUnit.php');
	}
